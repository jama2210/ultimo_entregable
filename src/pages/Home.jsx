...
const Home = () => {
  ...
  return (
    ...
    <div className="searchbox">
      ...
      <input placeholder="What are you looking for?" value={inputValue} onChange={handleChange} type="text" />
      <button>
        ...
        {productsFilter?.filter(filterCallBack).length !== 0 ? (
          ...
          .map((product) => (
            <CardProduct key={product.id} product={product} />
              ...
              <h1 className="noexist">Not exist products to this filter or price</h1>
              )}
      </div>
    </div>
    </div>
